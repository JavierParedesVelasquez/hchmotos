    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="main col">
                ...
                ?>
                <form action="editarProducto.php?producto_id=<?php echo $fila['id_producto'] ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="panel1">
                                ...
                                <div class="panel-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="txtproducto" name="txtproducto"  value="<?php echo $fila['nombre_producto'] ?>"  placeholder="Ingrese Nombre del Producto" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Precio:</label>
                                        <input type="text" class="form-control" id="txtprecio" name="txtprecio"  value="<?php echo $fila['precio_producto'] ?>"  placeholder="Ingresar Precio del Producto" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="panel1">
                                ...
                                <div class="panel-body">
                                    <div class="mb-3">
                                        <td><img style="width:200px;" src="data:image/jpg;base64,<?php echo base64_encode($fila['imagen_producto']) ?>" alt=""></td> <br>
